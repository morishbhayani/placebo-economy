...
with open("data/case_studies/turbo_cancer/evidence_profile.json") as f:
    evidence = json.load(f)

with open("data/case_studies/turbo_cancer/meme_evidence_divergence.json") as f:
    med = json.load(f)
...
timeline = pd.read_csv("data/processed/diffusion_timeline.csv")
...
with open("data/case_studies/turbo_cancer/llm_analysis.json") as f:
