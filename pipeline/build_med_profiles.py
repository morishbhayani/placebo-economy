...
with open("data/processed/narrative_evidence_verdicts.json") as f:
    evidence = json.load(f)

with open("data/processed/meme_dna_profiles.json") as f:
    dna = json.load(f)
...
with open("data/processed/med_profiles.json", "w") as f:
